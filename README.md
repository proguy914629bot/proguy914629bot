...
- 🔭 I’m currently working on <a href="https://github.com/YodaBotOS">@YodaBotOS</a>, <a href="https://github.com/OpenRobot-Packages">@OpenRobot-Packages</a>, and more!
- 💻 I currently have an <a href="https://api.yodabot.xyz">API (currently down)</a> with tons of stuff like Music Genre Prediction/Classification, OCR, Lyrics and more!
- 🌱 I’m currently learning a lot of things! Some of them are AWS, Azure, Python, HTML, CSS, JavaScript, SQL (mainly PostgreSQL and SQLite), Redis and RethinkDB, and lots more!
- 📫 How to reach me (Connections):
<ul>
    <li>Socials Website: <a href="https://socials.proguy.me">proguy's socials</a></li>
